...
<template>
  <SeoMeta
    title="Cookie Settings | Buyzin - Manage Your Preferences in Bangladesh"
    description="Control and manage your cookie preferences on Buyzin. Learn how we use essential, performance, functional, and marketing cookies while shopping online in Bangladesh."
    keywords="Buyzin Cookie Settings, manage cookies Bangladesh, website cookies preferences, online shopping privacy, ecommerce cookie control, Buyzin"
  />

  <div class="max-w-4xl mx-auto px-6 py-12">
    <!-- Header -->
    <div class="text-center mb-10">
      <h1 class="text-4xl font-bold mb-3 text-gray-900">Cookie Settings</h1>
      <p class="text-gray-500">
        Manage how Buyzin uses cookies to enhance your shopping experience.
      </p>
    </div>
    ...
    <div class="space-y-8 text-gray-700 leading-relaxed">
      <section>
        ...
        <p>
          ...
          website. They help us improve functionality, analyze traffic, and
      ...
      <section>
        ...
        <p>
          You can choose which cookies to accept or decline below. You can also
          modify your preferences at any time in your browser settings.
        </p>
      ...
      <!-- More Info -->
      <section>
        <h2 class="text-2xl font-semibold mb-3 text-gray-900">4. Learn More</h2>
        <p>
          For more information about how we use cookies and protect your data,
          please read our
